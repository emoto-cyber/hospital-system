<?php
        ...
        $success = array();
            ...
            VALUES ('$firstname', '$lastname', '$email','$secret', '$hashed_passcode',NOW(),'2' )";
...
#success{
    ...
    text-align:center;
       ...
       <p> You are being redirected to alupe sub-county website to login ...</p>
        <br>
        </div>";
        exit();
                ...
                header('Refresh:3; URL=labtechsignup.php');
