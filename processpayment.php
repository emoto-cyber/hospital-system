<?php
        ...
        $success = array();
            ...
            // Make the query:
            $q = "INSERT INTO payment_details( firstname,lastname, email,medicine,payment_method,amount,date)
            VALUES ('$firstname', '$lastname', '$email','$medicine','$method','$amount',NOW() )";
...
#success{
    ...
    text-align:center;
        ...
        <h1 style=margin-top:150px;>Thank you for adding  patient payment information</h1>
        <br>
        </div>";
        exit();
