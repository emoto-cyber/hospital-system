...
?>
    <?php
require("processbill.php");
    ?>
<form class="form" method="post" name="login" action="billing.php">
                 <h1 class="login-title"> Medicine Billing Information </h1>
