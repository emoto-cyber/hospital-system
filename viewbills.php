...
<div class="row">
 ...
 // Table header.
 echo"<h1 style='color:green;margin-top:10px;text-align:center'>These are available patients medicine bills</h1>";
 ...
 <td>' . $date . '</td>
 <td><a style=padding:0; href=viewbills.php?email=' . $email .'>Pay</a></td>
  </tr>';
  }
  echo '</table>';
...
?>
 <?php
require("processpayment.php");
    ?>
<form class="form" method="post" name="login" action="viewbills.php">
                 <h1 class="login-title">Patient Payment  Information </h1>
...
value=
 "<?php echo$med?>" >        
 <select style="width: 100%;border-radius:2px;height:30px;text-align:center" name="method" required>
                          <option value="">-Select payment method-</option>
                              <option>Cash</option>
                              <option>M-Pesa</option>
                              <option>Credit Card</option>
                                </select><br><br>
                                <input type="number" placeholder="Enter amount" name="mt"  class="login-input" required  title=
"Alphabetic and space only max of 30 characters"
value=
 "<?php echo$mt?>" >
