...
?>
    <?php
require("processadd.php");
    ?>
<form class="form" method="post" name="login" action="addpatient.php">
                 <h1 class="login-title">Patient Information </h1>
...
<input type="number" name="secret" placeholder="Enter your age" class="login-input"  title=
...
"Numeric  only max of 10 characters"  required>
 <select style="width: 100%;border-radius:2px;height:30px;text-align:center" name="gender" required>
                          <option value="">-Select your gender-</option>
                              <option>Male</option>
                              <option>Female</option>
                                </select><br><br>
                 
  <input type="name" placeholder="Enter your address" name="address"  class="login-input" required  title=
"Alphabetic and space only max of 30 characters"
value=
